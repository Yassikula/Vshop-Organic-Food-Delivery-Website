...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
	...
	<div  style="height: 350px; background-image: url(assets/img/portfolio/product.jpg); width: 1060px; margin-top: 250px;margin-left: 125px; background-size:cover; background-position: center center;" data-section="home">
...
<div class="cardside"  >
<a class="atext" style="margin-top: -260px; font-size: 21px;">ALL CATEGORIES</a>
							
									</ul><br>
								 <i style="font-size:14px; color: rgba(15, 86, 132, 1);" class="fa">&#xf105;</i><a href="#friut">Fruit Juices</a>	<br>
									 <i style="font-size:14px; color: rgba(15, 86, 132, 1);" class="fa">&#xf105;</i><a href="#vege">Vege Juices</a><br>	
									 <i style="font-size:14px; color: rgba(15, 86, 132, 1);" class="fa">&#xf105;</i><a href="#can">Canned Products</a>	<br>
								 <i style="font-size:14px; color: rgba(15, 86, 132, 1);" class="fa">&#xf105;</i><a href="#about">Freash Juices</a>	<br>
									<i style="font-size:14px; color: rgba(15, 86, 132, 1);" class="fa">&#xf105;</i><a href="#about">Freash Juices</a>	<br>
									 <i style="font-size:14px; color: rgba(15, 86, 132, 1);" class="fa">&#xf105;</i><a href="#about">Freash Juices</a>	
...
<section id="friut" >
        ...
        <div class="col-md-12">
			...
			<?php
				$query = "SELECT * FROM tbl_product WHERE type= 'fruitproduct' ORDER BY id ASC";
	 ...
	 <!-- <div class="col-md-3"> -->
	 <a class="atext" style="left: -3px;top: 147px;">Fruit Juices</a>

<form   method="post" action="product.php?action=add&id=<?php echo $row["id"]; ?>"  >

<div class="card" style="width:18rem; padding:20px;width: 240px;margin-bottom: -185px; margin-left: 125px;margin-right: -87px;    
 margin-top: 244px; border: solid;border-width: thin;border-color: ghostwhite;; overflow: hidden;  position: relative;     " >
...
<br>
	  ...
	  <lable style="    position: absolute;  left: 75px; top: 303px;" >Per  250 g(s)</lable>
...
background: none;top: 4px; width: 100px;height: 38px;font-size:26px;border-radius: 0px;"  class="fa fa-shopping-cart"  >  </button>
<div class= "heartbtn">
...
<section id="vege" >
		...
		<div class="container"  >
			...
			<div class="row">
        <div class="col-md-12">
            <!-- <h1>VEGETABLES</h1><br><br> -->
            <!-- <div class="d-flex"> -->
                <div class="card-deck" style="margin-right: -201px;display: inline-flex;  margin-left: -168px;" >
			<?php
				$query = "SELECT * FROM tbl_product WHERE type= 'vegeproduct' ORDER BY id ASC";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
	 ...
	 <!-- <div class="col-md-3"> -->
<a class="atext" style="left: -3px;top: 147px;">Vegetables Juices</a>

	 <form   method="post" action="order.php?action=add&id=<?php echo $row["id"]; ?>"  >
  
   <div class="card" style="width:18rem; padding:20px;width: 240px;margin-bottom: -185px; margin-left: 125px;margin-right: -87px;     margin-top: 244px; border: solid;border-width: thin;border-color: ghostwhite;; overflow: hidden;  position: relative;     " >
...
<!-- 	   
	   ...
	   <input type="number" id="myNumber"name="quantity" value="1" class="qt" style="   height: 28px;text-align: center;font-size: 15px;" />
       <button type="submit" name="add_to_cart" style="   border: none;  color:white;
    background: none; width: 100px;height: 38px;font-size:26px;border-radius: 0px;"  class="fa fa-shopping-cart"  >  </button>
<div class= "heartbtn">
...
<section id="can" >
		...
		<div class="container"  >
            ...
            <!-- <div class="d-flex"> -->
                <div class="card-deck" style="margin-right: -201px;display: inline-flex;  margin-left: -168px;" >
			<?php
				$query = "SELECT * FROM tbl_product WHERE type= 'canproduct' ORDER BY id ASC";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
	 ...
	 <!-- <div class="col-md-3"> -->
<a class="atext" style="left: -3px;top: 147px;">Caned Products</a>
...
<div class= "heartbtn">
	   ...
	   <button type="submit" name="add_to_cart"  class="fa fa-heart"  style=" border-radius: 30px; background: none; height: 28px; 
	    font-size:17px; top: 4px; width: 30px;text-align: center; color:white; position: absolute; left: 144px;border: none;" ></button>
	   </div>
	   </div>
